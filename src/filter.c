    ...
    for (int i = 0; i < image_height; i++) {
        ...
        while (true) {
            ...
            if (current_filter_method == 0) { // NO FILTER
                ...
                pixels[pixels_len].rgb.r = r_bit;
                pixels[pixels_len].rgb.g = g_bit;
                pixels[pixels_len].rgb.b = b_bit;
                pixels[pixels_len].rgb.a = a_bit;

                pixels[pixels_len].col = height_index;
                pixels[pixels_len].row = (row_index - 1) / 4;
                pixels_len++;
    ...
    for(int i = 0; i < image_height; i++) {
        ...
        while (true) {
            ...
            if (current_filter_method == 0) { // NO FILTER
                ...
                pixels[pixels_len].rgb.r = gray_scale;
                pixels[pixels_len].rgb.g = gray_scale;
                pixels[pixels_len].rgb.b = gray_scale;
                pixels[pixels_len].rgb.a = 255;
    ...
    for (int i = 0; i <image_height; i++) {
        ...
        while (true) {
            ...
            if (current_filter_method == 0) { // NO FILTER
                ...
                pixels[pixels_len].rgb.g = gray_scale;
                pixels[pixels_len].rgb.b = gray_scale;
                pixels[pixels_len].rgb.a = opacity_scale;
