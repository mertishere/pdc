...
utils = src/utils/constants.c src/utils/conversions.c src/utils/hex.c src/utils/buffer.c src/utils/file.c src/utils/vectors.c
algorithms = src/algorithms/decompress.c src/algorithms/lzss.c src/algorithms/huffman.c src/algorithms/filter.c
